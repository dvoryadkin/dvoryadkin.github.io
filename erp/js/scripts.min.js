...
$(".header__menu-button").click(function(){$(".main__navbar").toggleClass("hidden-xs")}),$("#button-1").click(function(){$("#solution-1").slideToggle()}),$("#button-2").click(function(){$("#solution-2").slideToggle()}),$("#button-3").click(function(){$("#solution-3").slideToggle()}),$("#button-4").click(function(){$("#solution-4").slideToggle()}),$("#button-5").click(function(){$("#solution-5").slideToggle()}),$("#button-6").click(function(){$("#solution-6").slideToggle()}),$("#button-7").click(function(){$("#solution-7").slideToggle()}),$("#button-8").click(function(){$("#solution-8").slideToggle()}),$("#button-9").click(function(){$("#solution-9").slideToggle()});